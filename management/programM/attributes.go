...
logfile=/edge/logfile/jxcore.log
...
directory=/edge/gateway/bin
command=./gateway -c gateway.cfg
...
stdout_logfile=/edge/logfile/%(program_name)s_stdout.log
stdout_logfile_maxbytes=50MB
stdout_logfile_backups=10
stdout_capture_maxbytes=0
stdout_events_enabled=true
stderr_logfile=/edge/logfile/%(program_name)s_stderr.log
