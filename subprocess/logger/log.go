...
func (l *FileLogger) getLogFileName(index int) string {
	t := time.Now()
	l.dateInt = date(t)
	return fmt.Sprintf("%s.%d-%s.log", l.name, index, t.Format("2006-01-02"))
}
...
// NewLogger create a logger for a programM with parameters
//
